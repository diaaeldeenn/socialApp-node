...
export const updateProfileSchema = z.object({
    firstName: z
        ...
        .trim()
        .regex(/^[a-zA-Z0-9\s\-_]+$/, "firstName can only contain letters, numbers, spaces, - and _"),
    lastName: z
        .string({
        ...
        .trim()
        .regex(/^[a-zA-Z0-9\s\-_]+$/, "lastName can only contain letters, numbers, spaces, - and _"),
    age: z
        .number({
    ...
    phone: z
        .string()
        .regex(/^01[0125][0-9]{8}$/, "Please enter a valid Egyptian mobile number starting with 010, 011, 012 or 015 followed by 8 digits")
        .optional()
        .or(z.literal("")),
    gender: z
